...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _SoccerPlayer = __webpack_require__(10);

  var _SoccerPlayer2 = _interopRequireDefault(_SoccerPlayer);

  var SoccerPlayerList = _react2['default'].createClass({
  ...
  exports['default'] = SoccerPlayerList;
  module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _SoccerPlayerList = __webpack_require__(4);

  var _SoccerPlayerList2 = _interopRequireDefault(_SoccerPlayerList);

  var InstantBox = _react2['default'].createClass({
    displayName: 'InstantBox',
    ...
    renderResults: function renderResults() {
      return _react2['default'].createElement(_SoccerPlayerList2['default'], { data: this.state.filteredData });
    },
    render: function render() {
  ...
  var SearchBox = _react2['default'].createClass({
    ...
    render: function render() {
      return _react2['default'].createElement('input', { className: 'searchbar-edit', type: 'text', ref: 'searchInput', placeholder: 'Search Name', value: this.props.query, onChange: this.doSearch });
    }
  });

  exports['default'] = InstantBox;
  module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var SoccerPlayer = (function (_Component) {
    _inherits(SoccerPlayer, _Component);

    function SoccerPlayer() {
      _classCallCheck(this, SoccerPlayer);

      _get(Object.getPrototypeOf(SoccerPlayer.prototype), 'constructor', this).apply(this, arguments);
    }
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _componentsSoccerPlayerList = __webpack_require__(4);

  var _componentsSoccerPlayerList2 = _interopRequireDefault(_componentsSoccerPlayerList);

  var _componentsInstantBox = __webpack_require__(7);

  var _componentsInstantBox2 = _interopRequireDefault(_componentsInstantBox);
    ...
    _createClass(_default, [{
      ...
      value: function render() {
        return _react2['default'].createElement(
          'div',
          null,
          _react2['default'].createElement(_componentsInstantBox2['default'], null)
        );
      }
    }]);
